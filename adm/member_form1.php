...
공란시 현재 시간</td>
    ...
    <tr>
        ...
        <td>
            <input type="text" name="new_mb_id" value="<?php echo $mb['mb_id'] ?>" id="new_mb_id"  class="frm_input"  size="20"  maxlength="20">
<?
			if($w=='u'){?>
...
<input type="text" name="mb_hp" value="<?php echo $mb['mb_hp'] ?>" id="mb_hp" class="frm_input" size="20" maxlength="20"></td>
    ...
    <th scope="row" class='txt_fail'>직접추천인</th>
        <td colspan="3" ><span class='txt_fail'><?php echo $mb['mb_servant_cnt']?$mb['mb_servant_cnt']:'0'?>명</span>
        </td>
    <!--tr>
      <th scope="row">추천인</th>
