...
<td class="td_right"><?php echo "<span>".number_format2($row['trade_amt'])."</span>"?>/<?php echo "<span class='fblue'>".number_format2($row['soled_amt'])."</span>"?>/<?php echo "<span class='fred'>".number_format2($row['ct_buy_price']-$row['soled_amt'])."</span>"?></td>
