...
<form name="fboardlist" id="fboardlist" action="./insert_reserve_list_update.php" onsubmit="return fboardlist_submit(this);" method="post">
...
<th rowspan="2" scope="col"><?php echo subject_sort_link('a.mb_id') ?>아이디</th>
        <th rowspan="2" scope="col">연락처</a></th>
...
<div class="btn_fixed_top">
    ...
    <a href="./insert_reserve_form.php" id="rt_add" class="btn_04 btn">입금추가</a>
</div>
