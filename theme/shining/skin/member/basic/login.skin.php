...
<div id="wrap" style="height:100vh">
	<div style="padding:10px">
		<img src="<?php echo G5_THEME_URL ?>/images/head_login.png" style="width:100%" width=100% alt="">
		<div style="padding:100px 10px 0;text-align:center">
...
.login button{ width: 100%; height: 3.125rem; margin: 0; background-color: #fff; outline: none; color: #fff; text-transform: uppercase; font-size: 1rem; letter-spacing: 0.2rem; color: #07243e; font-weight: 700; }
.login .signUp{ width: 100%; height: 3.125rem; line-height: 3.125rem; margin: 32px 0 0; background: rgba(0,0,0,0.6); position: relative; text-align: center; border: 2px solid #fff; }
