...
<div id="Contents" class="main_con">
    ...
    <ul id="sec2" class="sec_wrap sec2_wrap">
        ...
        <li><a href="/for_common/stonedetail.php"><img src="<?=G5_THEME_URL?>/images/sec2_img3.png" /> 보유금액 : <?=number_format2($rpoint['i']['_enable'])?></a></li>
    </ul>
    ...
    <ul id="sec3" class="sec_wrap sec3_wrap">
        <li>
            <?php
            $sql =  "select sum(ac_auto_a) as cnt_a,sum(ac_auto_b) as cnt_b,sum(ac_auto_c) as cnt_c from  {$g5['cn_sub_account']} where mb_id='$member[mb_id]'";
            $row = sql_fetch($sql);
            ?>
            <a href="/for_common/automatching.php">
                <div class="img">
                    <div class="in" style="background-image:url(<?=G5_THEME_URL?>/images/new_sec3_img1.jpg);">
                        <span class="t"><?=$row['cnt_a']+$row['cnt_b']+$row['cnt_c']?>개</span>
                    </div>
                </div>
        ...
        <li>
            <a href="/for_common/incomplete.php?stats_stx=1-1">
                <div class="img">
                    <div class="in" style="background-image:url(<?=G5_THEME_URL?>/images/new_sec3_img2.jpg);">
                        <span class="t"><?=$buyer_stats[cnt_stats_1]?$buyer_stats[cnt_stats_1]:0?>개</span>
                    </div>
                </div>
        ...
        <li>
            <a href="/for_common/incomplete.php?stats_stx=2-1">
                <div class="img">
                    <div class="in" style="background-image:url(<?=G5_THEME_URL?>/images/new_sec3_img3.jpg);">
    ...
    <ul id="sec3" class="sec_wrap sec3_wrap">
        ...
        <li>
            <a href="/for_common/notice_account.php">
                <div class="img">
                    <div class="in" style="background-image:url(<?=G5_THEME_URL?>/images/new_sec3_img5.jpg);">
        ...
        <li>
            <a href="https://m.navimall.co.kr/" target="_blank">
                <div class="img">
                    <div class="in" style="background-image:url(<?=G5_THEME_URL?>/images/new_sec3_img6.jpg);"></div>
                </div>
    ...
    <ul id="sec4" class="sec_wrap sec4_wrap">
        ...
        <li><a href="#"><img src="<?=G5_THEME_URL?>/images/sec4_img2.png" /></a></li>
