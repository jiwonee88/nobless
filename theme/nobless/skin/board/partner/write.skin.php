...
<section id="bo_w">
    ...
    <?php if ($option) { ?>
    <div class="write_div skin skin-square">
        <span class="sound_only">옵션</span>
        <?php echo str_replace("type=\"checkbox\"","type=\"checkbox\" class=\"frm_check\"",$option) ?>
    </div>
    <?php } ?>
    ...
    <div class="bo_w_tit write_div">
        ...
        <div id="autosave_wrapper write_div">
            <input type="text" name="wr_subject" value="<?php echo $subject ?>" id="wr_subject" required class="form-control full_input required" size="50" maxlength="255" placeholder="Subject">
            <?php
    ...
    <div class="write_div">
        ...
        <div class="wr_content <?php echo $is_dhtml_editor ? $config['cf_editor'] : ''; ?>">
            ...
            if($is_dhtml_editor) echo $editor_html;
            else echo "<textarea id=\"wr_content\" name=\"wr_content\" class=\"form-control\" maxlength=\"65536\" style=\"width:100%;height:300px\">$content</textarea>";
    ...
    <div class="bo_w_flie write_div">
        ...
        <span class="file_del">
            <input type="checkbox" id="bf_file_del<?php echo $i ?>" name="bf_file_del[<?php echo $i;  ?>]" value="1" class='frm_check'> <label for="bf_file_del<?php echo $i ?>"><?php echo $file[$i]['source'].'('.$file[$i]['size'].')';  ?> 파일 삭제</label>
        </span>
        <?php } ?>
    ...
    <div class="btn_confirm write_div text-center">
        ...
        <input type="submit" value="작성완료" id="btn_submit" accesskey="s" class="btn btn-dark">
    </div>
    </form>
