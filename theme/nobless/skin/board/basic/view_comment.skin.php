...
<button type="button" class="cmt_btn"><i class="far fa-comments"></i> 댓글목록</button>
<!-- 댓글 시작 { -->
<section id="bo_vc">
    <h2>댓글목록</h2>
    <?php
    ...
    <article id="c_<?php echo $comment_id ?>" <?php if ($cmt_depth) { ?>style="margin-left:<?php echo $cmt_depth ?>px;border-top-color:#e0e0e0"<?php } ?>>
        ...
        <div class="cmt_contents">
            ...
            <ul class="bo_vc_act">
                ...
                <?php if ($list[$i]['is_del'])  { ?><li><a href="<?php echo $list[$i]['del_link'];  ?>" onclick="return comment_delete();" class="btn_b03 obje-red">삭제</a></li><?php } ?>
            </ul>
            <?php } ?>
        </div>
...
<aside id="bo_vc_w" class="bo_vc_w">
    ...
    <div class="bo_vc_w_wr">
        ...
        <div class="btn_confirm">
            <input type="checkbox" name="wr_secret" value="secret" id="wr_secret" class='frm_check'>
            <label for="wr_secret"><i class="fa fa-lock" aria-hidden="true"></i><span class="sound_only">비밀글사용</span></label>&nbsp;&nbsp;
            <input type="submit" id="btn_submit" class="lsbtn lsbtn-md obje-blue" value="댓글등록">
        </div>
    </div>
    </form>
</aside>
