...
<?php if($bo_table=='notice'){?>
		<img src="<?php echo G5_THEME_URL ?>/images/head_notice.png" style="width:100%;margin-bottom:50px" width=100% alt="">
    <?php }?>
<section id="bo_w">
    ...
    <div class="btn_confirm write_div">
        <a href="./board.php?bo_table=<?php echo $bo_table ?>" class="lsbtn lsbtn-md obje-gray">취소</a>
        <input type="submit" value="작성완료" id="btn_submit" accesskey="s" class="lsbtn lsbtn-md obje-blue">
    </div>
    </form>
